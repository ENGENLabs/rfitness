...
export default function QRCode() {
  const handleDownload = () => {
    // Create a link element to download the static QR code
    const link = document.createElement('a');
    link.download = 'gym-checkin-qr.png';
    link.href = '/qr-code.png'; // Path to the static QR code in the public directory
    link.click();
  };
